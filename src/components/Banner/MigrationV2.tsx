...
import { Text, Flex, Box, ErrorIcon, Button } from '@beagleswap/uikit'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any BeagleSwap LP tokens and BeagleSwap farms.
        </Text>
